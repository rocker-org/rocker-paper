...
and run Docker containers without root privileges, as most cluster administrators require \citep{singularity}. Another LBNL project, *Shifter*, allows Docker containers to be deployed on supercomputing
architectures such as CRAY \citep{shifter}.


Importantly, Rocker containers are just as easy to run locally on most modern laptops
...
the RStudio default. Many academic and commercial cloud providers make it
...
into a browser and entering the
...
<!-- DE The (+46,000 as hadleyverse) is visually very awkward. Can the "+46k" be a footnote? I know nothing about Markdown tables but would be happy to redo 1 + 2 in latex ...-->
