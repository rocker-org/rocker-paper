...
images can easily be extended by any user writing their own Dockerfiles based
on an appropriate Rocker image.  
...
Rocker Project, such as the [Dockerfile Best Practices](), the use of automated builds,
...
- Dockerfiles. community input.  [`hlapp/rpopgen`](https://github.com/NESCent/popgen-docker)
