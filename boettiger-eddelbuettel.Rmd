...
by first issuing the appropriate Docker command (or distribution) for Windows, MacOS, and Linux-based
...
The `docker run` option `-p` sets the port on which RStudio will appear, for which 8787 is
...
runtime environment, Singularity \citep{singularity}.  
